...
namespace BoxingAndUnboxing.Benchmarks
{
    ...
    public class Benchy
    {
        ...
        [Benchmark]
        public object BoxValue() => BoxingService.BoxValue(420);

        [Benchmark]
        public int UnboxValue() => BoxingService.UnboxValue(Boxed);
        [Benchmark]
        public int SimpleReturn() => BoxingService.SimpleReturnInt(420);

        [Benchmark]
        public object SimpleReturnObject() => BoxingService.SimpleReturnObject(Boxed);
    }
